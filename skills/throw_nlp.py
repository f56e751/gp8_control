...
# W1 0.5→5.0 상향 (2026-07-24 사용자 ablation: 36/36 조합에서 t_f 단축). 시간 항을
# 키워 더 빠른(짧은 t_f) 스윙을 선호 — W_ACC(착탄) 대비 상대 비중이 커진 것이라
# 정확도는 게이트(30mm)가 계속 보장한다. w1은 formulation 키라 warm DB 무효화.
