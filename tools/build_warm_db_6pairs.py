...
TARGETS: list[tuple[float, float, float]] = [
    # 저bin 6쌍 v2 (run_static_pick_throw_trash.sh, 2026-07-27 사용자, x=1.09/1.40, press 0.04 → lift 0.19).
    (1.09, 0.16, -0.11), (1.09, 0.16, -0.11),
    (1.09, -0.16, -0.11), (1.09, -0.16, -0.11),
    (1.40, 0.00, -0.11), (1.40, 0.00, -0.11),
]
...
P_STARTS: list[tuple[float, float, float]] = [
    # POINTS (0.40/0.50, y) → lift z=0.19, TARGETS 와 1:1 (순서 그대로)
    (0.40, 0.20, 0.19), (0.40, 0.00, 0.19),
    (0.40, -0.20, 0.19), (0.50, 0.20, 0.19),
    (0.50, 0.00, 0.19), (0.50, -0.20, 0.19),
]
